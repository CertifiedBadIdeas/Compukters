...
include("addon-api", commonModulesDir)
include("addon-guest-api", commonModulesDir)
include("addon-gradle-plugin", commonModulesDir)
include("addon-guest-api-fixture", commonModulesDir)
