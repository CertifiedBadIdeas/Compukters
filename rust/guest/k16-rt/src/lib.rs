...
pub mod host_test {
    pub use k16_abi::syscall::{
        ...
        ERROR_NO_ENTRY, ERROR_NO_MEMORY, EXIT, FD_STDERR, FD_STDIN, FD_STDOUT, OPEN, READ, RUN,
        SBRK, SLEEP_TICKS, STATUS_OK, WRITE, YIELD,
    };
...
pub use trap::{
    ...
    iret_with_r0, open_syscall, read_syscall, restore_trap_frame, run_syscall, save_trap_frame,
    sbrk_syscall, set_interrupt_mask, sleep_ticks_syscall, syscall0, syscall1, syscall3,
    syscall_arg0, syscall_arg1, syscall_arg2, syscall_once, trap_cause, trap_pc, trap_value,
