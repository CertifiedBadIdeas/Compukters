...
`native/k16-vm` and `native/k16-tools`. Documentation is in `docs/`, active machine ABI references are in `docs/abi`,
...
- `cargo test` from `native/k16-vm` or `native/k16-tools` runs Rust crate tests.
