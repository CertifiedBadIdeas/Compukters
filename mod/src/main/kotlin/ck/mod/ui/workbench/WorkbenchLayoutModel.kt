 ...
 */
package ck.mod.ui.workbench

import ck.mod.application.workbench.WorkbenchState
...
class WorkbenchLayoutModel(
    ...
    fun completionPopup(state: WorkbenchState): CompletionPopupLayout? {
        ...
        val visibleItems = state.editor.completionItems.size.coerceAtMost(MAX_COMPLETION_ITEMS)
        val labelsWidth =
