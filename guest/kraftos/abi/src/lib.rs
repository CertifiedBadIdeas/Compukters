...
pub mod syscall {
    ...
    pub const MAX_RUN_PATH_BYTES: usize = 65;
    ...
    pub const MAX_SPAWN_ARGV_REQUEST_BYTES: usize = MAX_RUN_ARGV_REQUEST_BYTES;
...
pub mod computer {
    ...
    pub mod control {
        ...
        pub const OS_STATS_ADDR: u32 = 0x1000_0010;
        pub const OS_STATS_SIZE: u32 = 0x1000_0014;
    ...
    pub mod mmu0 {
        ...
        pub const BYTE_COUNT: u32 = PAGE_COUNT;
        ...
        pub const ERROR_INVALID_ADDRESS_SPACE: i32 = 3;
        pub const ERROR_TRANSLATION_FAULT: i32 = 4;
        pub const ERROR_PHYSICAL_OUT_OF_BOUNDS: i32 = 5;
        pub const ERROR_BYTE_COUNT_OVERFLOW: i32 = 6;
        pub const COMMAND_NOP: i32 = 0;
...
mod tests {
    ...
    fn computer_mmio_constants_match_current_k16_profile() {
        ...
        assert_eq!(computer::control::OS_STATS_ADDR, 0x1000_0010);
        assert_eq!(computer::control::OS_STATS_SIZE, 0x1000_0014);
        ...
        assert_eq!(computer::mmu0::BYTE_COUNT, 0x1000_081c);
        ...
        assert_eq!(computer::mmu0::ERROR_INVALID_ADDRESS_SPACE, 3);
        assert_eq!(computer::mmu0::ERROR_TRANSLATION_FAULT, 4);
        assert_eq!(computer::mmu0::ERROR_PHYSICAL_OUT_OF_BOUNDS, 5);
        assert_eq!(computer::mmu0::ERROR_BYTE_COUNT_OVERFLOW, 6);
    ...
    fn syscall_constants_match_current_k16_kernel_proof_surface() {
        ...
        assert_eq!(syscall::SPAWN, 22);
        assert_eq!(syscall::WAIT, 23);
        ...
        assert_eq!(syscall::SPAWN_ARGV_MAGIC, 0x5741_5053);
        assert_eq!(syscall::MAX_RUN_ARGS, 4);
        assert_eq!(syscall::MAX_RUN_PATH_BYTES, 65);
        assert_eq!(syscall::MAX_RUN_ARG_BYTES, 128);
        assert_eq!(syscall::MAX_RUN_ARGV_REQUEST_BYTES, 605);
        assert_eq!(syscall::MAX_SPAWN_ARGV_REQUEST_BYTES, 605);
