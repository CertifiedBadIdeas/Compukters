...
pub mod host_test {
    pub use k16_abi::syscall::{
        ...
        ERROR_NOT_EMPTY, ERROR_NO_ENTRY, ERROR_NO_MEMORY, ERROR_READ_ONLY, EXIT, FD_STDERR,
        FD_STDIN, FD_STDOUT, GAME_TICKS, MKDIR, OPEN, READ, READ_DIR, RENAME, RMDIR, RUN,
        RUN_FORMAT_ARGV, SBRK, SEEK, SLEEP_TICKS, SPAWN, STAT, STATUS_OK, UNLINK, WAIT, WRITE,
        YIELD,
    };
