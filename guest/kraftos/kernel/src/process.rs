...
pub const MAX_RUN_PATH_BYTES: usize = BIN_PREFIX.len() + KFS_MAX_NAME_BYTES;
...
unsafe fn read_selected_dynamic_import_state(
    ...
    let main_file = unsafe { crate::fs::root_volume().selected_inode.file_metadata() };
