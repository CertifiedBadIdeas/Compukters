...
import ru.lazyhat.compukterkraft.core.workbench.WorkbenchEditorViewModelTestSupport.makeStoreWithDocument
        ...
        runTest(UnconfinedTestDispatcher()) {
            val store =
                makeStoreWithDocument(
                    ...
                    "",
                    target =
                        ru.lazyhat.compukterkraft.core.workbench.WorkbenchTargetState(
                            connected = true,
