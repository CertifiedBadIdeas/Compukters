...
object KeyConverter {
     ...
     * @param inputProvider The platform input provider for key name resolution.
     * @return The translated key code.
     */
    fun physicalToActual(
        key: Int,
        scanCode: Int,
        inputProvider: PlatformInputProvider,
    ): Int {
        val name = inputProvider.getPhysicalKeyName(key, scanCode)
        ...
        if (character in 'a'..'z') return KeyCodes.KEY_A + (character.code - 'a'.code)
