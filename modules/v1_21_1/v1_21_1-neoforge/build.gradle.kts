...
val ruxCompilerManifest = rootProject.layout.projectDirectory.file("native/k16-tools/Cargo.toml")
val k16BiosSource = rootProject.layout.projectDirectory.file("native/k16-tools/examples/firmware/k16_bios.rx")
val k16BootSource = rootProject.layout.projectDirectory.file("native/k16-tools/examples/boot/kernel_loader.rx")
val k16KernelSource = rootProject.layout.projectDirectory.file("native/k16-tools/examples/kernel/display_ok.rx")
