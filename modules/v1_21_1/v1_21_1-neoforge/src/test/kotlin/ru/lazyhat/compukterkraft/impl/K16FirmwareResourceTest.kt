...
class K16FirmwareResourceTest {
    ...
    fun bundledK16FirmwareBuildUsesK16GradleSurface() {
        ...
        assertTrue(source.contains("--emit=obj="))
        assertTrue(source.contains("tasks.register<Exec>(\"compileK16SystemBootObject\")"))
        assertTrue(source.contains("tasks.register<Exec>(\"compileK16SystemKernelObject\")"))
