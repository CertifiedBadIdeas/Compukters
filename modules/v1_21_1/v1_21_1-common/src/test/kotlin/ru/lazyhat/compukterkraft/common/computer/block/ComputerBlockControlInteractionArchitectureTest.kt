...
class ComputerBlockControlInteractionArchitectureTest {
    private val source =
        Paths
            .get("src/main/kotlin/ru/lazyhat/compukterkraft/common/computer/block/AbstractComputerBlock.kt")
            .readText()

    @Test
    fun blockRightClickOwnsPowerOnAndControlMenuFlow() {
