...
class ComputerControlScreenArchitectureTest {
    private val source =
        Paths
            .get("src/main/kotlin/ru/lazyhat/compukterkraft/common/computer/screen/ComputerControlScreen.kt")
            .readText()

    @Test
    fun controlScreenSendsExistingComputerActions() {
        assertTrue(source.contains("ComputerActionServerMessage"))
