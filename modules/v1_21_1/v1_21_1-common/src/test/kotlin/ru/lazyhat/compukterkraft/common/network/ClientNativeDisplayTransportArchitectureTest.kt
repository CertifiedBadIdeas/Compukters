...
class ClientNativeDisplayTransportArchitectureTest {
    private val contextSource =
        Paths
            .get("src/main/kotlin/ru/lazyhat/compukterkraft/common/network/ClientNetworkContextImpl.kt")
            .readText()
