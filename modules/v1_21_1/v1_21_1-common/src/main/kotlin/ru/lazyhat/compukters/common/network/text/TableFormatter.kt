...
package ru.lazyhat.compukters.common.network.text

import net.minecraft.ChatFormatting
import net.minecraft.network.chat.Component
import net.minecraft.network.chat.MutableComponent
import ru.lazyhat.compukters.common.network.text.ChatHelpers.coloured
...
interface TableFormatter {
    ...
    fun display(table: TableBuilder) {
        ...
        if (table.additional > 0) {
            writeLine(
                id,
                Component.translatable("commands.compukters.generic.additional_rows", table.additional).withStyle(ChatFormatting.AQUA),
            )
        }
    }
