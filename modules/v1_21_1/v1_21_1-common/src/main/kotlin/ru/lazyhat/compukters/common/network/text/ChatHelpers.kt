...
object ChatHelpers {
    ...
    fun bool(value: Boolean): MutableComponent =
        if (value) {
            Component.translatable("commands.compukters.generic.yes").withStyle(ChatFormatting.GREEN)
        } else {
            Component.translatable("commands.compukters.generic.no").withStyle(ChatFormatting.RED)
        }
