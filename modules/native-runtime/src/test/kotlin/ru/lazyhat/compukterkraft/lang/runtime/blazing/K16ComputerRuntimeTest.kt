...
class K16ComputerRuntimeTest {
    ...
    fun decodesNativeStatsSnapshotLongArray() {
        ...
        assertEquals(NativeK16DecodeCacheStats(entries = 58, hits = 59, misses = 60), snapshot.decodeCache)
        assertEquals(
            listOf(
                NativeK16MmioDeviceStats(
                    ...
                    storage =
                        NativeK16StorageStats(
                            ...
                            mediaWriteBlocks = 23,
                            uniqueReadBlocks = 24,
                            repeatedReadBlocks = 25,
                            partitionTableReadBlocks = 26,
                            bootMetadataReadBlocks = 27,
                            bootDataReadBlocks = 28,
                            rootMetadataReadBlocks = 29,
                            rootDataReadBlocks = 30,
                            unknownReadBlocks = 31,
                            requestedReadBlocks = 32,
                            requestedReadBytes = 33,
                        ),
                    gpu =
                        NativeK16GpuStats(
