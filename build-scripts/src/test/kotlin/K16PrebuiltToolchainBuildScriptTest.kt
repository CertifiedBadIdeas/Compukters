...
class K16PrebuiltToolchainBuildScriptTest {
    ...
    fun neoforgeBuildInstallsPinnedPrebuiltToolchainArchive() {
        ...
        assertTrue(rootBuildScript.contains("inputs.dir(rootProject.file(\"rust/guest/k16-abi/src\"))"))
        assertTrue(rootBuildScript.contains("inputs.file(rootProject.file(\"rust/guest/k16-abi/Cargo.toml\"))"))
        assertTrue(k16ToolchainSupport.contains("\"source-host-tools\""))
        assertTrue(k16ToolchainSupport.contains("sourceK16HostToolsToolchainRoot"))
        assertTrue(k16ToolchainSupport.contains("source-host-tools"))
        assertTrue(gradleSandboxDev.contains("gradlew-sandbox"))
        assertTrue(gradleSandboxDev.trimEnd().endsWith("\"$@\" -Pk16ToolchainMode=source-host-tools"))
        ...
        assertTrue(docs.contains("-Pk16ToolchainMode=source-host-tools"))
