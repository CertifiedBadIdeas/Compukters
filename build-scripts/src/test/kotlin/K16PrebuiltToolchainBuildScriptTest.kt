...
class K16PrebuiltToolchainBuildScriptTest {
    ...
    fun neoforgeBuildInstallsPinnedPrebuiltToolchainArchive() {
        ...
        val k16FirmwareProducerConvention =
        ...
        assertTrue(k16FirmwareConvention.contains("id(\"k16-firmware-producer-convention\")"))
        assertTrue(k16FirmwareProducerConvention.contains("rootProject.tasks.named(\"prepareK16Toolchain\")"))
        assertTrue(k16FirmwareProducerConvention.contains("resolveK16Toolchain()"))
        assertTrue(k16FirmwareProducerConvention.contains("processBuilder.environment()[\"RUSTC_BOOTSTRAP\"] = \"1\""))
        assertTrue(k16FirmwareProducerConvention.contains("-C linker=\${toolchain.linker.absolutePath}"))
        assertTrue(k16FirmwareProducerConvention.contains("toolchain.cli.absolutePath"))
        ...
        assertFalse(k16FirmwareProducerConvention.contains("providers.environmentVariable(\"K16_CARGO\")"))
        assertFalse(k16FirmwareConvention.contains("providers.environmentVariable(\"K16_RUSTC\")"))
        assertFalse(k16FirmwareProducerConvention.contains("providers.environmentVariable(\"K16_RUSTC\")"))
        assertFalse(k16FirmwareConvention.contains("providers.environmentVariable(\"K16_LD\")"))
        assertFalse(k16FirmwareProducerConvention.contains("providers.environmentVariable(\"K16_LD\")"))
