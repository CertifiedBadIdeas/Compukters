...
class K16TinyCcBuildScriptTest {
    ...
    fun tinyCcK16BuildIsOutOfTreePinnedAndHostOnly() {
        ...
        assertTrue(buildScript.contains("gradleProperty(\"k16TinyCcSourceDir\")"))
    ...
    fun cSdkCompilerRuntimeSelectionIsPinnedValidatedAndPartitioned() {
        ...
        assertTrue(producerConvention.contains("gradleProperty(\"k16LlvmSourceDir\")"))
        assertTrue(producerConvention.contains("k16LlvmSourceRoot.dir(\"compiler-rt/lib/builtins\")"))
        assertTrue(producerConvention.contains("k16LlvmSourceRoot.file(\"compiler-rt/LICENSE.TXT\")"))
    ...
    fun nativeTinyCcIsCrossBuiltWithAPrivateGuestOnlyConfigurationAndExactSymbolClosure() {
        ...
        assertTrue(producerConvention.contains("gradleProperty(\"k16TinyCcSourceDir\")"))
