...
class K16FontTableGeneratorTest {
    @Test
    fun generatesGuestRustTableFromHeaderDrivenK16FontSource() {
        val source = fontSource()

        val generated = K16FontTableGenerator().generate(source)

        assertTrue(generated.guestRustSource.contains("pub const GLYPH_WIDTH: usize = 5;"))
        assertTrue(generated.guestRustSource.contains("pub const GLYPH_HEIGHT: usize = 8;"))
        assertTrue(generated.guestRustSource.contains("pub const CELL_WIDTH: usize = 5;"))
        assertTrue(generated.guestRustSource.contains("pub const CELL_HEIGHT: usize = 8;"))
        assertTrue(generated.guestRustSource.contains("pub const GLYPH_X: usize = 0;"))
        assertTrue(generated.guestRustSource.contains("pub const GLYPH_Y: usize = 0;"))
        assertTrue(generated.guestRustSource.contains("TERMINAL_FONT_ROWS"))
    }
    ...
    fun generatorDefinesGuestRustFontTableOutput() {
        ...
        assertFalse(taskSource.contains("rustOutput"))
    ...
    fun generatedFontArtifactsUseK16Branding() {
        ...
        assertTrue(generated.guestRustSource.contains("Generated by ./gradlew generateK16FontTables"))
        assertTrue(generated.markdownSpecimen.contains("# K16 Terminal Font Specimen"))
        assertTrue(generated.markdownSpecimen.contains("Source: assets/k16/fonts/k16-terminal.font"))
        assertFalse(generated.guestRustSource.contains("generateRuxFontTables"))
