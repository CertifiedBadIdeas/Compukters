...
class K16FontTableGeneratorTest {
    ...
    fun generatesMarkdownSpecimenFromK16FontSource() {
        ...
        assertTrue(generated.markdownSpecimen.contains("# K16 Terminal 6x8 Font Specimen"))
        assertTrue(generated.markdownSpecimen.contains("- Glyph size: 6x8"))
        assertTrue(generated.markdownSpecimen.contains("- Cell size: 6x8"))
    ...
    fun generatedFontArtifactsUseK16Branding() {
        ...
        assertTrue(generated.markdownSpecimen.contains("# K16 Terminal 6x8 Font Specimen"))
        assertTrue(generated.markdownSpecimen.contains("Source: assets/k16/fonts/k16-terminal-6x8.font"))
    ...
    private fun fontSource(): String = Path.of("..", "assets", "k16", "fonts", "k16-terminal-6x8.font").readText()
