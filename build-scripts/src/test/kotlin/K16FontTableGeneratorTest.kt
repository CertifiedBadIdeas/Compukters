...
class K16FontTableGeneratorTest {
    @Test
    fun generatesRustAndKotlinTablesFromK16FontSource() {
    ...
    fun generatedFontArtifactsUseK16Branding() {
        ...
        assertTrue(generated.kotlinSource.contains("Generated by ./gradlew generateK16FontTables"))
        assertTrue(generated.markdownSpecimen.contains("# K16 Mono 5x7 Font Specimen"))
        ...
        assertFalse(generated.kotlinSource.contains("generateRuxFontTables"))
