...
Issue: [#185](https://github.com/CertifiedBadIdeas/Compukter-Kraft/issues/185), [#186](https://github.com/CertifiedBadIdeas/Compukter-Kraft/issues/186)
...
`debug_suffix=7c7c` means the timer0 driver wrote `||` (`0x7c 0x7c`) after two `advance_game_tick()` calls.
