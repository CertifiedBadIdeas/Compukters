...
**Tech Stack:** Rust, `native/rux-vm`, `native/rux-compiler`, cargo tests.
...
**Files:**
- Modify: `native/rux-vm/src/low_machine.rs`
...
- [ ] Run `cargo test --offline --manifest-path native/rux-compiler/Cargo.toml --test compiler_seed`.
...
**Files:**
- Modify: `docs/superpowers/specs/2026-05-13/2026-05-13-rust-like-bare-metal-language-seed-design.md`
