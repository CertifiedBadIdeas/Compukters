...
```bash
git add docs/superpowers/specs/2026-05-14/2026-05-14-rust-like-seed-loop-control-design.md docs/superpowers/plans/2026-05-14/2026-05-14-rust-like-seed-loop-control.md native/rux-compiler/src/ast.rs native/rux-compiler/src/lexer.rs native/rux-compiler/src/parser.rs native/rux-compiler/src/codegen.rs native/rux-compiler/tests/compiler_seed.rs
