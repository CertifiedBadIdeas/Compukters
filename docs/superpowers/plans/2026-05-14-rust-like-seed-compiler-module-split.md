...
**Tech Stack:** Rust 2021, Cargo, `ckl-vm::low_image`, existing `native/ckl-compiler` tests.

---

## File Structure

- Create: `native/ckl-compiler/src/error.rs`
- Create: `native/ckl-compiler/src/lexer.rs`
- Create: `native/ckl-compiler/src/ast.rs`
- Create: `native/ckl-compiler/src/parser.rs`
- Create: `native/ckl-compiler/src/codegen.rs`
- Modify: `native/ckl-compiler/src/lib.rs`
- Existing tests: `native/ckl-compiler/tests/compiler_seed.rs`
...
git add native/ckl-compiler/src/lib.rs native/ckl-compiler/src/error.rs native/ckl-compiler/src/lexer.rs
...
cargo test --offline --manifest-path native/ckl-compiler/Cargo.toml
cargo fmt --manifest-path native/ckl-compiler/Cargo.toml --check
git add native/ckl-compiler/src/lib.rs native/ckl-compiler/src/ast.rs native/ckl-compiler/src/parser.rs
...
cargo test --offline --manifest-path native/ckl-compiler/Cargo.toml
cargo fmt --manifest-path native/ckl-compiler/Cargo.toml --check
git add native/ckl-compiler/src/lib.rs native/ckl-compiler/src/codegen.rs
