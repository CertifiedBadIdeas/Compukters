...
**Предусловие:** Эпик 1 (`docs/superpowers/plans/2026-04-24/2026-04-24-terminal-stream-io-epic-1.ru.md`) завершён. VM уже пишет поток VT-100 в `ComputerStdioApi`; серверный `VmStdioApi` пока разбирает его обратно в `ScreenBuffer`. Именно этот мост Эпик 2 и разбирает.
