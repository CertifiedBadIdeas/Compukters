...
- Create `docs/superpowers/plans/2026-05-25-issue-69-rux16-mmio-firmware-smoke.md`: this plan.
...
```bash
git add docs/superpowers/plans/2026-05-25-issue-69-rux16-mmio-firmware-smoke.md
