...
**Files:**
- Verify: `docs/superpowers/specs/2026-05-24/2026-05-24-issue-52-rux-storage-mmio-contract-design.md`
...
```bash
rg -n "TBD|TODO|FIXME|placeholder" docs/abi docs/superpowers/specs/2026-05-24/2026-05-24-issue-52-rux-storage-mmio-contract-design.md native/rux-vm/src
```
