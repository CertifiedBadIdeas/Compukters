...
**Goal:** Move all source files to feature-first package layout per the design spec at `docs/superpowers/specs/2026-04-15-feature-first-restructuring-design.md`.
...
**Files:**
- `docs/superpowers/specs/2026-04-15-feature-first-restructuring-design.md` (already created)
...
```bash
git add docs/superpowers/specs/2026-04-15-feature-first-restructuring-design.md
