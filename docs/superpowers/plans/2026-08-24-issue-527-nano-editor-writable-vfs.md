...
- [x] **Step 1: Write failing execution and rejection tests**
...
- [x] **Step 3: Implement the bounded instruction**
...
- [x] **Step 1: Write failing model/encoding tests**
...
- [x] **Step 3: Add model, encoder, cost, and validator support**
...
- [x] **Step 4: Verify GREEN and cross-language conformance**
...
- [x] **Step 1: Add a failing compiler-produced conformance test**
...
- [x] **Step 3: Extend the canonical Kotlin library model**
...
- [x] **Step 4: Lower array built-ins**
...
- [x] **Step 1: Write failing Rust capability tests**
...
- [x] **Step 3: Implement generic Rust operations**
...
- [x] **Step 4: Add Guest declarations and trusted lowering tests**
...
- [x] **Step 5: Verify GREEN and commit both repositories**
...
- [x] **Step 1: Write failing trusted-symbol and machine tests**
...
- [x] **Step 3: Add declarations and mappings**
...
- [x] **Step 1: Write failing pure buffer tests**
...
- [x] **Step 3: Implement `CharArray` gap-buffer helpers**
...
- [x] **Step 4: Implement the 51x19 TUI and lifecycle**
...
- [x] **Step 5: Compile twice and verify deterministic artifacts**
...
- [x] **Step 1: Write failing ROM and runtime tests**
...
- [x] **Step 3: Package and invoke the artifact**
...
- [x] **Step 1: Add a failing persistent programming-loop GameTest**
