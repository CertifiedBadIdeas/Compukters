...
**Spec:** [docs/superpowers/specs/2026-05-22-github-issues-roadmap-design.md](../specs/2026-05-22-github-issues-roadmap-design.md)
...
- Modify: `docs/superpowers/specs/2026-05-22-todos-roadmap-workflow-design.md` — prepend `## Superseded` banner.
- Modify: `docs/superpowers/plans/2026-05-22-todos-roadmap-workflow.md` — prepend `## Superseded` banner.
...
**Files:**
- Modify: `docs/superpowers/specs/2026-05-22-todos-roadmap-workflow-design.md`
- Modify: `docs/superpowers/plans/2026-05-22-todos-roadmap-workflow.md`

- [ ] **Step 1: Prepend a Superseded banner to the previous spec**

At the very top of `docs/superpowers/specs/2026-05-22-todos-roadmap-workflow-design.md` (before the existing `# TODOs Inbox + ROADMAP Workflow` heading) insert these three lines and a blank line:
...
At the very top of `docs/superpowers/plans/2026-05-22-todos-roadmap-workflow.md` (before the existing `# TODOs Inbox + ROADMAP Workflow — Implementation Plan` heading) insert these three lines and a blank line:
...
Run: `head -3 docs/superpowers/specs/2026-05-22-todos-roadmap-workflow-design.md docs/superpowers/plans/2026-05-22-todos-roadmap-workflow.md`
Expected: each file's first non-blank line starts with `> **Superseded by**`.

- [ ] **Step 4: Commit**

```bash
git add docs/superpowers/specs/2026-05-22-todos-roadmap-workflow-design.md \
