...
Per docs/superpowers/specs/2026-04-30-device-authoring-domain-model-design.md
Phase 1, item 1."
```
...
```
8. Workbench (компьютерный стол) — реализован как отдельная Authoring Station, см. [docs/superpowers/specs/2026-04-16-workbench-separate-entity-design.md](superpowers/specs/2026-04-16-workbench-separate-entity-design.md) и доменную модель в [docs/superpowers/specs/2026-04-30-device-authoring-domain-model-design.md](superpowers/specs/2026-04-30-device-authoring-domain-model-design.md). Дальнейшие итерации (multi-target, апгрейды, live-загрузка, запуск из IDE) — отдельные фичи, добавляются по мере необходимости.
```
