...
**Prerequisite:** Plan A (`docs/superpowers/plans/2026-05-01-scope-operator-and-implicit-builtins.md`) must be merged. This plan assumes `::` is the scope operator, `.` is field access, builtins are ambient, and `import` declarations currently emit a hard error.
