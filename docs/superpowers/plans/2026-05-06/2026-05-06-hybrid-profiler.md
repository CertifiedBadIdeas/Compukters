...
root = Path('.')
paths = [
    root / 'docs/superpowers/specs/2026-05-06/2026-05-06-hybrid-profiler-design.ru.md',
    root / 'docs/superpowers/plans/2026-05-06/2026-05-06-hybrid-profiler.ru.md',
]
...
```bash
git add docs/superpowers/plans/2026-05-06/2026-05-06-hybrid-profiler.md
