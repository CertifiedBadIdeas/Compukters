...
**Предусловие:** План A (`docs/superpowers/plans/2026-05-01/2026-05-01-scope-operator-and-implicit-builtins.md`) должен быть смёржен. Этот план предполагает, что `::` — оператор области, `.` — доступ к полю, builtins — ambient, а `import`-объявления сейчас выдают жёсткую ошибку.
