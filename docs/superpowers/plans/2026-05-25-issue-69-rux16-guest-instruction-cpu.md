...
**Files:**
- Create: `docs/superpowers/plans/2026-05-25-issue-69-rux16-guest-instruction-cpu.md`
...
```bash
git add docs/superpowers/plans/2026-05-25-issue-69-rux16-guest-instruction-cpu.md
...
```text
Plan: docs/superpowers/plans/2026-05-25-issue-69-rux16-guest-instruction-cpu.md
```
