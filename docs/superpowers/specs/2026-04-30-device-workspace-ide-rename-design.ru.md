...
Phase 2a (`docs/superpowers/specs/2026-04-30-device-umbrella-rename-design.md`) исключила IDE/Workspace типы с обоснованием «это Authoring-сторона, переименовывать в `Device*` неправильно». Перепроверка показала, что обоснование было ошибочным:
