...
│    ├─ display::fillRect()/copyRect()/blitMono()/present()           │
│    │                                  ──►  DisplayRegistry           │
