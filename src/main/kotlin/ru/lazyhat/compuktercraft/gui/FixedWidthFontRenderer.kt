...
import ru.lazyhat.compuktercraft.gui.RenderTypes.FULL_BRIGHT_LIGHTMAP
...
object FixedWidthFontRenderer {
    val FONT: ResourceLocation = ResourceLocation.fromNamespaceAndPath(CompukterCraftMod.ID, "textures/gui/term_font.png")
