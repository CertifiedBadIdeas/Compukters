...
object PlayerCreativeLootCondition : LootItemCondition {
    override fun test(lootContext: LootContext): Boolean {
        CompukterCraftMod.LOGGER.info("CREATIVE")
        val entity: Entity? = lootContext.getParamOrNull(LootContextParams.THIS_ENTITY)
        return entity is Player && entity.abilities.instabuild
    }
