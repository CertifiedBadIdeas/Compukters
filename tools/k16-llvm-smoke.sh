...
run_k16 disasm --target program --start 0x10000 --count 96 "$WORK_DIR/main.kx" > "$WORK_DIR/main-kx.disasm"
...
run_k16 disasm --target program --start 0x10000 --count 128 "$WORK_DIR/call-helper.kx" > "$WORK_DIR/call-helper-kx.disasm"
...
run_k16 disasm --target program --start 0x10000 --count 96 "$WORK_DIR/stack-local-main.kx" > "$WORK_DIR/stack-local-main-kx.disasm"
